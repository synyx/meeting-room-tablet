...
public class LobbyActivity extends ReservatorActivity implements OnMenuItemClickListener, DataUpdatedListener,
    ...
    public void roomListUpdated(List<Room> rooms) {
        ...
        HashSet<String> hiddenRooms = (HashSet<String>) settings.getStringSet(getString(
                    R.string.PREFERENCES_UNSELECTED_ROOMS), new HashSet<String>());
    ...
    private void processRoom(Room r) {
        ...
        for (int index = 0; index < roomCount; index++) {
            Room r2 = ((LobbyReservationRowView) container.getChildAt(index)).getRoom();
