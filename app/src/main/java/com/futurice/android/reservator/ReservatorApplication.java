...
import com.synyx.android.reservator.config.LobbyConfig;
...
public class ReservatorApplication extends Application {
    ...
    public void onCreate() {
        ...
        String usedAccount = getSharedPreferences(getString(R.string.PREFERENCES_NAME), Context.MODE_PRIVATE)
                .getString(getString(R.string.PREFERENCES_ACCOUNT), getString(R.string.allAccountsMagicWord));
