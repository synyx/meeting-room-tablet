...
public class LobbyReservationRowView extends FrameLayout implements OnClickListener, OnItemClickListener {

    View cancelButton, bookNowButton, reserveButton, calendarButton, bookingMode, normalMode, titleView;
    ...
    public void onClick(View v) {
        ...
        if (v == bookNowButton) {
            ...
            RoomActivity.startWith((Activity) getContext(), getRoom(), application.getDataProxy());
        }
    }
    ...
    private void reservatorError(ReservatorException e) {
        ...
        alertBuilder.setTitle(getContext().getString(R.string.faildReservation)).setMessage(e.getMessage());
    ...
    public void setNormalMode() {
        ...
        if (animationDuration > 0) {
            Animation scale = new ScaleAnimation(1.0f, 1.0f, 1.0f, 0.0f, ScaleAnimation.RELATIVE_TO_SELF, 0.5f,
            ...
            scale.setAnimationListener(new AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        ...
                        Animation scale = new ScaleAnimation(1.0f, 1.0f, 0.0f, 1.0f, ScaleAnimation.RELATIVE_TO_SELF,
    ...
    private void switchToReserveModeContent() {
        ...
        String otherReservationView = application.getApplicationContext()
                .getString(R.string.reserv_view_spinner_change);
    ...
    private class MakeReservationTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                new MakeReservations().doReservation(application, name, room, timePicker2.getTimeSpan(), name);
            } catch (ReservatorException e) {
                reservatorError(e);
            }
